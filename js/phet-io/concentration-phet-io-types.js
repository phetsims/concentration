...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "ArrayIO.<SoluteIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<SoluteIO>",
      "typeName": "ArrayIO.<SoluteIO>"
    },
    "ArrayIO.<StringIO>": {
      "documentation": "A wrapper for the built-in JS array type, with the element type specified.",
      "events": [],
    ...
    "FunctionIO.(RangeIO)=>VoidIO": {
      ...
      "supertype": "ParametricTypeImplIO.<RangeIO, VoidIO>",
    ...
    "FunctionIO.(RangeIO,NullableIO.<RangeIO>)=>VoidIO": {
      ...
      "supertype": "ParametricTypeImplIO.<RangeIO, NullableIO.<RangeIO>, VoidIO>",
      "typeName": "FunctionIO.(RangeIO,NullableIO.<RangeIO>)=>VoidIO"
    },
    "FunctionIO.(SoluteIO)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> SoluteIO<br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
      ...
      "supertype": "ParametricTypeImplIO.<SoluteIO, VoidIO>",
      "typeName": "FunctionIO.(SoluteIO)=>VoidIO"
    },
    "FunctionIO.(SoluteIO,NullableIO.<SoluteIO>)=>VoidIO": {
      ...
      "supertype": "ParametricTypeImplIO.<SoluteIO, NullableIO.<SoluteIO>, VoidIO>",
    ...
    "NullableIO.<RangeIO>": {
      ...
      "supertype": "ParametricTypeImplIO.<RangeIO>",
    ...
    "ParametricTypeImplIO.<RangeIO, NullableIO.<RangeIO>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<RangeIO, NullableIO.<RangeIO>, VoidIO>"
    },
    "ParametricTypeImplIO.<RangeIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<RangeIO, VoidIO>"
    },
    "ParametricTypeImplIO.<RangeIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<RangeIO>"
    },
    "ParametricTypeImplIO.<SoluteIO, NullableIO.<SoluteIO>, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<SoluteIO, NullableIO.<SoluteIO>, VoidIO>"
    },
    "ParametricTypeImplIO.<SoluteIO, VoidIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<SoluteIO, VoidIO>"
    },
    "ParametricTypeImplIO.<SoluteIO>": {
      "documentation": "A Type that has parameters",
      "events": [],
      "methodOrder": [],
      "methods": {},
      ...
      "supertype": "ObjectIO",
      "typeName": "ParametricTypeImplIO.<SoluteIO>"
    },
