 ...
 */
require( [ 'JOIST/SimLauncher', 'JOIST/Sim', 'BEERS_LAW_LAB/concentration/ConcentrationScreen', 'BEERS_LAW_LAB/common/BLLStrings', 'BEERS_LAW_LAB/common/BLLImages' ],
  function( SimLauncher, Sim, ConcentrationScreen, BLLStrings, BLLImages ) {
    'use strict';
